...
`createPluginRuntimeTestHost()` also gains a comment fixture so plugin tests can establish moderation state without firing hooks, then exercise the real runtime and sandbox bridge through plugin routes or host actions.
