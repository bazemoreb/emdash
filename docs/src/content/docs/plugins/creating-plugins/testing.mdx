...
- `fixtures` creates site, collection, field, user, content, redirect, and plugin state without firing hooks.
...
- `inspect` reads content, redirects, plugin storage, KV, settings, plugin state, scheduled tasks, media, comments, and captured email.
